...
def main():
    ...
    for data_iter,data in enumerate(data_loader):
        ...
        for j in range(out.shape[0]):
            ...
            #save_single_image(gt[j],image_dir,j,name=config_name+"gt")
        # bayer
        #bayer_meas = np.array(single_meas.cpu())
        #save_single_image(bayer_meas,image_dir,ii,name=config_name+"meas")
    if time_count==0:
        time_count=1
